    ...
    >
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center px-6">
        ...
        <div className="relative h-[200px] flex items-center justify-center">
          <motion.h2
            className="absolute text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-white/60 text-center whitespace-nowrap"
            style={{
              opacity: oldOpacity,
              y: oldY,
              scale: oldScale,
          ...
          <motion.h2
            className="absolute text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-center whitespace-nowrap"
            style={{
              opacity: newOpacity,
              y: newY,
              scale: newScale,
